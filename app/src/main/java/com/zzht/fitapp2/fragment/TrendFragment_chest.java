...
public class TrendFragment_chest extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_trend_chest, null);
...
//        Log.i("test", "initCurveChart2: "+"help");
        List<Double> list = myDBHelper.selectChestByUid(Config.userId);
