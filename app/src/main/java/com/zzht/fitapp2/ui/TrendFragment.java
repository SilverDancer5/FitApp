...
import com.zzht.fitapp2.fragment.TrendFragment_chest;
import com.zzht.fitapp2.fragment.TrendFragment_weight;
...
public class TrendFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentList.add(new TrendFragment_weight());
        fragmentList.add(new TrendFragment_chest());
        fragmentList.add(new TrendFragment_weight());
        fragmentList.add(new TrendFragment_weight());
        fragmentList.add(new TrendFragment_weight());
        fragmentList.add(new TrendFragment_weight());
